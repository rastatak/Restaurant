                        ...
                        <table class="table table-striped table-dark">
                          ...
                          <?php 
                            ...
                            <form action="post/update_reservation.php?date=<?php echo $value["jour"]; ?>&id_resa=<?php echo $value["id_resa"]; ?>" method="POST">
                                ...
                                <td><input type="text" class="text-center w-50 bg-dark text-light" name="tel" value="<?php print $value["tel"]; ?>"></td>
                                <td><textarea name="commentaire" class="bg-dark text-light pl-1 pr-1" cols="15" rows="3"><?php print $value["commentaire"]; ?></textarea></td>
                                <td><input type="number" name="nb_pers" class="w-25 bg-dark text-light" value="<?php print $value["nb_pers"]; ?>"></td>
                                <td>
...
<!-- <td><input type="checked" id="toggle-trigger" name="presenceOuNon" data-toggle="toggle" data-on="N" data-off="O" data-onstyle="danger" data-offstyle="success" data-onvalue=""></td>  -->
                              ...
                              <td><button type="submit" name="update_reservation" class="btn btn-success" value="Modifier">SAVE<br/>💾</button></td>
                            </form>
                            </tr>
                            <?php } ?>
                          </tbody>
                          ...
                          <table class="table table-striped table-dark">
                            ...
                            <tbody>
                              ...
                              <form action="post/update_reservation.php?date=<?php echo $value["jour"]; ?>&id_resa=<?php echo $value["id_resa"]; ?>" method="POST">
                                ...
                                <td><?php print $value["mail"]; ?></td>
                                <td><input type="text"  class="text-center w-50 bg-dark text-light" name="tel" value="<?php print $value["tel"]; ?>"></td>
                                <td><textarea name="commentaire"  class="bg-dark text-light pl-1 pr-1" ><?php print $value["commentaire"]; ?></textarea></td>
                                <td><input type="number" name="nb_pers" class="w-25 bg-dark text-light" value="<?php print $value["nb_pers"]; ?>"></td>
                                <td>
<!-- Boutons radio "presence" -->
                                  <div class="form-check form-check-inline">
